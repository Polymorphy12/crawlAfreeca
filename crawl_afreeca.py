...
driver = webdriver.PhantomJS("C://Users/Sumin/Desktop/study/crawling/phantomjs/phantomjs-2.1.1-windows/bin/phantomjs.exe")
##driver = webdriver.Chrome('C:/Users/Sumin/Desktop/study/chromedriver')
#웹 자원 로드를 위해 3초까지 기다려준다.
driver.implicitly_wait(1)


#PhantomJS로 아프리카 TV URL을 실행한다.
...
for span in thumbnail_spans:
    thumb = span.find("img")
    urllib.request.urlretrieve(thumb["src"],"C://Users/Sumin/Desktop/study/crawling/thumbnails/afreeca2/"+ str(i)+".jpg")
    i += 1
    print(thumb["src"])
